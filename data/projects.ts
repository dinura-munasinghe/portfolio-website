...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "UI/UX Prototype",
    shortDesc: "A modern web dashboard for financial data visualization.",
    fullDesc: "An exploratory UI/UX design for a financial technology dashboard. The design focuses on presenting complex financial data, transaction histories, and analytics in a clean, readable, and highly aesthetic dark mode interface.",
    features: ["Dark Mode UI", "Data Visualisation Components", "Dashboard Layouts", "Component Library"],
    techStack: ["Figma", "UI/UX Design"],
    link: "https://www.figma.com/",
    coverImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80" // Placeholder
  },
